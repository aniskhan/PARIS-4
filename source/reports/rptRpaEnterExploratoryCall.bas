...
Begin Report
    ...
    Filter ="[Specialized Staff Required?] = True"
    RecSrcDt = Begin
        0x0100d971b7b7e440
    End
    ...
    PrtMip = Begin
        0xe0010000e0010000680100006801000000000000002d0000a032000001000000 ,
...
'///Error Handling
    If gcfHandleErrors Then On Error GoTo PROC_ERR
    PushCallStack Me.name & "." & "cmdFilterReport_Click"
'///Error Handling

'///Code

If Me.lboFEMASpecRequired.Value = "EHP" Then
    Me.Filter = "[EHP Staff Required at RSM] = True"
    Me.FilterOn = True
ElseIf Me.lboFEMASpecRequired.Value = "Insurance" Then
    Me.Filter = "[Insurance Staff Required at RSM] = True"
    Me.FilterOn = True
ElseIf Me.lboFEMASpecRequired.Value = "Mitigation" Then
    Me.Filter = "[Mitigation Staff Required at RSM] = True"
    Me.FilterOn = True
ElseIf Me.lboFEMASpecRequired.Value = "Other" Then
    Me.Filter = "[Specialized Staff Required?] = True"
    Me.FilterOn = True
ElseIf Me.lboFEMASpecRequired.Value = Null Then
    Me.FilterOn = False
End If
'///Code
