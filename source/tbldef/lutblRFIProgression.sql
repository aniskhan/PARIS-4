CREATE TABLE [lutblRFIProgression] (
  [ID] AUTOINCREMENT CONSTRAINT [Index_481B273D_73ED_421C] UNIQUE  CONSTRAINT [Index_D966679B_5AFD_4543] UNIQUE  CONSTRAINT [PrimaryKey] PRIMARY KEY  UNIQUE  NOT NULL ,
