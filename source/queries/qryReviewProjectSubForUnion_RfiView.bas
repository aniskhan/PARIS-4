...
Begin Joins
    ...
    Expression ="tblRFI.DisasterID = revtblProject.DisasterID"
    Flag =3
    LeftTable ="tblRFI"
    RightTable ="revtblProject"
    Expression ="tblRFI.ApplicantID = revtblProject.ApplicantID"
    Flag =3
    LeftTable ="tblRFI"
    RightTable ="revtblProject"
    Expression ="tblRFI.ProjectID = revtblProject.ProjectID"
    Flag =3
End
Begin OrderBy
    Expression ="revtblProject.ReviewEntryDate"
