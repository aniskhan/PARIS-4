Operation =1
Option =0
Where ="(((revtblRpa.ReviewType)=\"Scoping Meeting\" Or (revtblRpa.ReviewType)=\"DIU Ent"
    "er RSM\") And ((revtblRpa.ReviewExitDate) Is Null) And ((tblSubRecipient.Disaste"
    "rID)=Forms!navMain!DisasterID) And ((tblSubRecipient.Status)=\"ELIGIBLE\"))"
Begin InputTables
    Name ="revtblRpa"
