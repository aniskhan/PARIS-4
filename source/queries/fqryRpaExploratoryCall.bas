Operation =1
Option =0
Where ="(((revtblRpa.ReviewType)=\"Exploratory Call\" Or (revtblRpa.ReviewType)=\"DIU En"
    "ter Call\") And ((revtblRpa.ReviewExitDate) Is Null) And ((tblSubRecipient.Disas"
    "terID)=Forms!navMain!DisasterID) And ((tblSubRecipient.Status)=\"ELIGIBLE\"))"
Begin InputTables
    Name ="revtblRpa"
