Operation =1
Option =0
Where ="(((revtblProject.ReviewType)=\"Assign DAS\" Or (revtblProject.ReviewType)=\"DAS "
    "Review\" Or (revtblProject.ReviewType)=\"Submit in EMMIE\") AND ((revtblProject."
    "ReviewExitDate) Is Null))"
Begin InputTables
    Name ="tblProjects"
    Name ="revtblProject"
End
