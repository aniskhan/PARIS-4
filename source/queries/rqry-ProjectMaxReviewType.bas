dbMemo "SQL" ="SELECT revtblProject.ProjectID, revtblProject.[Lane Assigned], Last(revtblProjec"
    ...
    "IN revtblProject ON ([rqry-ProjectMaxRevEntry].MaxOfReviewEntryDate = revtblProj"
    "ect.ReviewEntryDate) AND ([rqry-ProjectMaxRevEntry].ProjectID = revtblProject.Pr"
    "ojectID)\015\012GROUP BY revtblProject.ProjectID, revtblProject.[Lane Assigned];"
    "\015\012"
dbMemo "Connect" =""
