Operation =1
Option =0
Where ="(((revtblRpa.ReviewType)=\"Enter Projects\") And ((revtblRpa.ReviewExitDate) Is "
    "Null) And ((tblSubRecipient.DisasterID)=Forms!navMain!DisasterID) And ((tblSubRe"
    "cipient.Status)=\"ELIGIBLE\"))"
Begin InputTables
    Name ="revtblRpa"
...
Begin
    ...
    End
    Begin
        dbText "Name" ="tblSubRecipient.Exit Meeting Information Entry Assigned To"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="tblSubRecipient.EMMIE Entry Assigned To"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="tblSubRecipient.Insurance Policy Received"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="tblSubRecipient.PAGS Notes"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="tblSubRecipient.Subrecipient Emergency Manager"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="tblSubRecipient.Is all disaster-related work completed"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="tblSubRecipient.Subrecipient Environmental/Historic Specialist"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="tblSubRecipient.Subrecipient Engineering Representative"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="tblSubRecipient.Are there any known Environmental or Historic Preservation Issu"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="tblSubRecipient.Can Site Inspections be conducted"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="tblSubRecipient.Subrecipient Finance Representative"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="tblSubRecipient.Subrecipient Insurance Risk Manager"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="tblSubRecipient.Subrecipient Public Works Staff"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="tblSubRecipient.Subrecipient Police/Fire Representatives"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="tblSubRecipient.Exploratory Call Checklist emailed to Subrecipient"
        dbLong "AggregateType" ="-1"
    End
End
Begin
