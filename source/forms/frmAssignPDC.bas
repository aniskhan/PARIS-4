        ...
        Begin FormHeader
            ...
            Begin
                Begin Label
                    ...
                    BorderColor =8355711
                    Name ="lbHeader"
                    Caption ="Subrecipient Information - Assign Program Delivery Manager (PDM)"
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    Begin
                        Begin Label
                            ...
                            Caption ="PDM Entered into EMMIE"
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT qryNames.UserID, qryNames.[Reverse Full Name], tblStaffRoles.DisasterID, "
                        ...
                        "= tblStaffRoles.StaffID WHERE (((tblStaffRoles.DisasterID)=Forms!frmAssignPDC!Di"
                        "sasterID) And ((tblStaffRoles.EndDate) Is Null Or (tblStaffRoles.EndDate)>=Date("
                        ")) And ((tblStaffRoles.Position)=\"PDM\")); "
                    ColumnWidths ="0;2880"
                    ...
                    Begin
                        Begin Label
                            ...
                            Caption ="Select  Program Delivery Manager (PDM):"
                ...
                Begin Subform
                    ...
                    BorderColor =10921638
                    Name ="subrptCounty"
                    SourceObject ="Report.subrptCountyAppPdc"
                    LinkChildFields ="DisasterID;County"
                    LinkMasterFields ="DisasterID;County"
                    GridlineColor =10921638
                ...
                Begin Subform
                    ...
                    BorderColor =10921638
                    Name ="subrptPdc"
                    SourceObject ="Report.subrptPdcCountyApp"
                    LinkChildFields ="DisasterID;Assigned PDC"
