Operation =1
Option =0
Where ="(((revtblRpa.ReviewType)=\"Ops Initial\" Or (revtblRpa.ReviewType)=\"OCC Review\""
    " Or (revtblRpa.ReviewType)=\"PAGS Review\" Or (revtblRpa.ReviewType)=\"DIU RPA E"
    "ligibility\") And ((revtblRpa.ReviewExitDate) Is Null) And ((tblSubRecipient.Dis"
    "asterID)=Forms!navMain!DisasterID))"
Begin InputTables
    Name ="revtblRpa"
